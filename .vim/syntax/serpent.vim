...
"
syn keyword pythonStatement	false, nil, true, t
syn keyword pythonStatement	as assert break continue del exec var
...
syn keyword pythonInclude	from require
...
if !exists("python_no_builtin_highlight")
  ...
  syn keyword pythonBuiltin	false true nil t
